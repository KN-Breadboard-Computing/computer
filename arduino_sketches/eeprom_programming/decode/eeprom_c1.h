...
MemoryCell NON_ZERO_MEMORY[124] = {
  { 0b0000000000010, 0b01111000 }, // EMPTY - MICROSTEP 2
  { 0b0000000000011, 0b01111000 }, // EMPTY - MICROSTEP 3

  { 0b0000000010010, 0b01111000 }, // MOVAB - MICROSTEP 2
  { 0b0000000010011, 0b01111000 }, // MOVAB - MICROSTEP 3

  { 0b0000000100010, 0b01111000 }, // MOVBA - MICROSTEP 2
  { 0b0000000100011, 0b01111000 }, // MOVBA - MICROSTEP 3

  { 0b0000000110010, 0b01111000 }, // MOVAIMM - MICROSTEP 2
  { 0b0000000110011, 0b00101000 }, // MOVAIMM - MICROSTEP 3
  { 0b0000000110100, 0b01111000 }, // MOVAIMM - MICROSTEP 4

  { 0b0000001000010, 0b01111000 }, // MOVBIMM - MICROSTEP 2
  { 0b0000001000011, 0b00101000 }, // MOVBIMM - MICROSTEP 3
  { 0b0000001000100, 0b01111000 }, // MOVBIMM - MICROSTEP 4

  { 0b0000001010010, 0b01111000 }, // MOVAABS - MICROSTEP 2
  { 0b0000001010011, 0b00101010 }, // MOVAABS - MICROSTEP 3
  { 0b0000001010100, 0b01111000 }, // MOVAABS - MICROSTEP 4
  { 0b0000001010101, 0b00101001 }, // MOVAABS - MICROSTEP 5
  { 0b0000001010110, 0b01111000 }, // MOVAABS - MICROSTEP 6
  { 0b0000001010111, 0b00101000 }, // MOVAABS - MICROSTEP 7
  { 0b0000001011000, 0b01111000 }, // MOVAABS - MICROSTEP 8

  { 0b0000001100010, 0b01111000 }, // MOVBABS - MICROSTEP 2
  { 0b0000001100011, 0b00101010 }, // MOVBABS - MICROSTEP 3
  { 0b0000001100100, 0b01111000 }, // MOVBABS - MICROSTEP 4
  { 0b0000001100101, 0b00101001 }, // MOVBABS - MICROSTEP 5
  { 0b0000001100110, 0b01111000 }, // MOVBABS - MICROSTEP 6
  { 0b0000001100111, 0b00101000 }, // MOVBABS - MICROSTEP 7
  { 0b0000001101000, 0b01111000 }, // MOVBABS - MICROSTEP 8

  { 0b0000001110010, 0b11111000 }, // MOVABSA - MICROSTEP 2
  { 0b0000001110011, 0b00101010 }, // MOVABSA - MICROSTEP 3
  { 0b0000001110100, 0b01111000 }, // MOVABSA - MICROSTEP 4
  { 0b0000001110101, 0b00101001 }, // MOVABSA - MICROSTEP 5
  { 0b0000001110110, 0b01110000 }, // MOVABSA - MICROSTEP 6
  { 0b0000001110111, 0b01010000 }, // MOVABSA - MICROSTEP 7
  { 0b0000001111000, 0b01111000 }, // MOVABSA - MICROSTEP 8

  { 0b0000010000010, 0b11111000 }, // MOVABSB - MICROSTEP 2
  { 0b0000010000011, 0b00101010 }, // MOVABSB - MICROSTEP 3
  { 0b0000010000100, 0b01111000 }, // MOVABSB - MICROSTEP 4
  { 0b0000010000101, 0b00101001 }, // MOVABSB - MICROSTEP 5
  { 0b0000010000110, 0b01110000 }, // MOVABSB - MICROSTEP 6
  { 0b0000010000111, 0b01010000 }, // MOVABSB - MICROSTEP 7
  { 0b0000010001000, 0b01111000 }, // MOVABSB - MICROSTEP 8

  { 0b0000010010010, 0b01111000 }, // MOVABSIMM - MICROSTEP 2
  { 0b0000010010011, 0b00101010 }, // MOVABSIMM - MICROSTEP 3
  { 0b0000010010100, 0b01111000 }, // MOVABSIMM - MICROSTEP 4
  { 0b0000010010101, 0b00101001 }, // MOVABSIMM - MICROSTEP 5
  { 0b0000010010110, 0b01111000 }, // MOVABSIMM - MICROSTEP 6
  { 0b0000010010111, 0b10101000 }, // MOVABSIMM - MICROSTEP 7
  { 0b0000010011000, 0b01111000 }, // MOVABSIMM - MICROSTEP 8
  { 0b0000010011001, 0b01010000 }, // MOVABSIMM - MICROSTEP 9
  { 0b0000010011010, 0b01111000 }, // MOVABSIMM - MICROSTEP 10

  { 0b0000010100010, 0b01111000 }, // MOVAF - MICROSTEP 2
  { 0b0000010100011, 0b01111000 }, // MOVAF - MICROSTEP 3

  { 0b0000010110010, 0b01111000 }, // MOVBF - MICROSTEP 2
  { 0b0000010110011, 0b01111000 }, // MOVBF - MICROSTEP 3
