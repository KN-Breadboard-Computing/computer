...
//181020/1369245/2.50/14/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "CD4081BEE4" (originalName "CD4081BEE4")
	...
	(compDef "CD4081BEE4" (originalName "CD4081BEE4") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "J=A.B") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "K=C.D") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "11" (pinName "M=G.H") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "L=E.F") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CD4081BEE4"))
		...
		(attr "Mouser Part Number" "595-CD4081BEE4")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/CD4081BEE4?qs=HTr%252BoA4jRiloxIEWd2QErQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "CD4081BEE4")
		(attr "Description" "AND Gate Quad 2-IN CMOS 14-Pin PDIP")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-SFU2/DSASFU100028830.pdf")
		(attr "<Component Height>" "5.08")
		(attr "<STEP Filename>" "CD4081BEE4.stp")
