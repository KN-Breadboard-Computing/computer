...
(library Library_1
	...
	(compDef "CD4081BEE4" (originalName "CD4081BEE4") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "J=A.B") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "K=C.D") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "11" (pinName "M=G.H") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "L=E.F") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-SFU2/DSASFU100028830.pdf")
		(attr "Height" "5.08 mm")
	)
