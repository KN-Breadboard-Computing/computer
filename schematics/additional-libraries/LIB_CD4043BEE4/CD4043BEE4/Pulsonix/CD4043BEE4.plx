...
//1158723/1369245/2.50/16/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "CD4043BEE4" (originalName "CD4043BEE4")
	...
	(compDef "CD4043BEE4" (originalName "CD4043BEE4") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "Q4") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "Q1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "R1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "R2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "15" (pinName "R4") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "14" (pinName "S4") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "13" (pinName "NC") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "12" (pinName "S3") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "11" (pinName "R3") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "Q3") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "Q2") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CD4043BEE4"))
		...
		(attr "Mouser Part Number" "595-CD4043BEE4")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/CD4043BEE4?qs=LSR%252BNeaw%2FwCLzQGHF2OlCw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "CD4043BEE4")
		(attr "Description" "Latch Transparent 3-ST 4-CH SR-Type 16-Pin PDIP Tube")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/cd4043bee4/texas-instruments")
		(attr "<Component Height>" "5.08")
		(attr "<STEP Filename>" "CD4043BEE4.stp")
