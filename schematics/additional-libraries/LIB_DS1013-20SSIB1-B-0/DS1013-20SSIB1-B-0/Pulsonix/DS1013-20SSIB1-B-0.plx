...
(library Library_1
	...
	(patternDef "SHDR20W69P254X254_2X10_3300X91" (originalName "SHDR20W69P254X254_2X10_3300X91")
		...
		(layerContents (layerNumRef 28)
			(line (pt -5.07 -3.28) (pt -5.07 6.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.07 6.2) (pt 28.18 6.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 28.18 6.2) (pt 28.18 -3.28) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 28.18 -3.28) (pt -5.07 -3.28) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "DS1013-20SSIB1-B-0" (originalName "DS1013-20SSIB1-B-0") (compHeader (numPins 20) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.tme.eu/Document/e9117e1c80532ff2c20cc520b4694ed9/DS1013.pdf")
		(attr "<Component Height>" "9.55")
		(attr "<STEP Filename>" "DS1013-20SSIB1-B-0.stp")
